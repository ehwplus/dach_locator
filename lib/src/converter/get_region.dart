...
GermanRegion? getGermanRegionCode(String plz) {
  ...
  final Map<GermanRegion, Set<String>> map = {
    ...
    GermanRegion.schleswigHolstein: {
      '21039-21039',
      '21451-21521',
      '21524-21529',
      '22113-22113',
    ...
    GermanRegion.nordrheinWestfalen: {
      '32001-33829',
      '34401-34439',
      '37651-37688',
      '37692-37696',
    ...
    GermanRegion.badenWuerttemberg: {
      '63928-63928',
      '64754-64754 ',
      '68001-68312',
      '68520-68549',
...
AustriaRegion? getAustriaRegionCode(String plz) {
  ...
  if (plz.length == 5) {
    ...
    final Map<AustriaRegion, Set<String>> map = {
      ...
      AustriaRegion.kaernten: {'9020-9781', '9800-9872'},
    };
